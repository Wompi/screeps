...
//            myCreep.moveTo(aSpawn);
    ...
    getGraph()
    {
        return  [
                    ...
                    {   x:  7,   y: 48, roomName:"E64N48", next:  5, },

                    {   x:  7,   y:  1, roomName:"E64N47", next:  6, },
                    {   x:  1,   y: 10, roomName:"E64N47", next:  7, },

                    {   x: 48,   y: 11, roomName:"E63N47", next:  8, },
                    {   x: 21,   y: 18, roomName:"E63N47", next:  9, },
                    {   x: 19,   y: 16, roomName:"E63N47", next:  10, },
                    {   x: 11,   y:  7, roomName:"E63N47", next:  11, },
                    {   x: 19,   y: 16, roomName:"E63N47", next:  12, },
                    {   x: 32,   y:  1, roomName:"E63N47", next:  13, },
                    {   x: 19,   y: 16, roomName:"E63N47", next:  14, },
                    {   x: 48,   y: 11, roomName:"E63N47", next:  15, },

                    {   x:  1,   y: 10, roomName:"E64N47", next:  16, },
                    {   x:  7,   y:  1, roomName:"E64N47", next:  17, },

                    {   x:  7,   y: 48, roomName:"E64N48", next:  18, },
                    {   x: 48,   y: 17, roomName:"E64N48", next:  19, },

                    {   x:  1,   y: 17, roomName:"E65N48", next:  20, },
                    {   x: 28,   y:  1, roomName:"E65N48", next:  21, },
