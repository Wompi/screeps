...
class Traveler {
    ...
    findTravelPath(origin, destination, options = {})
    {
        ...
        let allowedRooms;
        // logDERP('aName = '+origin.pos.roomName);
        // logDERP('bName = '+destination.pos.roomName);
    ...
    _travelTo(creep, destination, options = {}) {
        ...
        if (!travelData.path) {
            ...
            // logDERP(' creep = '+JSON.stringify(creep));
            // logDERP(' destination = '+JSON.stringify(destination));
            // logDERP(' options = '+JSON.stringify(options));
